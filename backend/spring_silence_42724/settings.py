"""
Django settings for spring_silence_42724 project.
...
ROOT_URLCONF = 'spring_silence_42724.urls'
...
WSGI_APPLICATION = 'spring_silence_42724.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_silence_42724 API",
    "DESCRIPTION": "API documentation for spring_silence_42724 App",
    "VERSION": "v1",
}
